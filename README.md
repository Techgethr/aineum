...
- Custom RPC for Electroneum (own node, ANKR, or any else option)
...
3. Set up environment variables:
   ...
   ELECTRONEUM_HTTP_ENDPOINT=http_endpoint_to_use_electroneum
   ```
...
#### Read Operations
- **get_balance**: Check wallet balances on the Electroneum network
...
3. **Blockchain Integration**:
   ...
   - Operations are executed on the Electroneum network
